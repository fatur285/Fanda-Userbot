...
async def _(event):
   ...
   # input_str = event.pattern_match.group(1)
    ...
    animation_chars = [
        ...
        "Heroku Connecting To Latest Github Build (DIORrios28/Fanda-Userbot)",
        ...
        "INFO - Fanda-Userbot: Logged in as 557667062",
        "INFO - Fanda-Userbot: Successfully...",
        "919852+00:00 app[worker.1]: 919 - Fanda-Userbot -",
        "INFO -  🔥Fanda-Userbot🔥  ⚙️ V5.0 [TELAH DIAKTIFKAN!]",
        "**Build Succeeded**"
